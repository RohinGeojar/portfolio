...
function sendmail() {
    ...
    let successBox = document.querySelector(".sent-message");
    ...
    emailjs.send("service_3w4nv2o", "template_026tp0s", parms) 
        .then(() => {
            loadingBox.style.display = "none";
        ...
        .catch((error) => {
            loadingBox.style.display = "none";
            errorBox.innerText = "❌ Failed to send. Try again later.";
